...
namespace OG\OGCRUD\Tests\Unit;

use Illuminate\Support\Facades\Config;
use OG\OGCRUD\Facades\OGCRUD;
use OG\OGCRUD\Tests\TestCase;

class OgCrudTest extends TestCase
{
    /**
    ...
    {
        Config::set('ogcrud.dashboard.widgets', [
            'OG\\OGCRUD\\Tests\\Stubs\\Widgets\\AccessibleDimmer',
            'OG\\OGCRUD\\Tests\\Stubs\\Widgets\\AccessibleDimmer',
        ]);

        $dimmers = OGCRUD::dimmers();
    ...
    public function testDimmersReturnsCollectionOfConfiguredWidgetsWhichShouldBeDisplayed()
    {
        Config::set('ogcrud.dashboard.widgets', [
            'OG\\OGCRUD\\Tests\\Stubs\\Widgets\\AccessibleDimmer',
            'OG\\OGCRUD\\Tests\\Stubs\\Widgets\\InAccessibleDimmer',
            'OG\\OGCRUD\\Tests\\Stubs\\Widgets\\InAccessibleDimmer',
        ]);
