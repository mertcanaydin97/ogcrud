...
class VoyagerController extends Controller
{
    ...
    {
        return OGCRUD::view('ogcrud::index');
    }
    ...
    public function logout()
    {
        ...
        return redirect()->route('ogcrud.login');
    }
    ...
    public function upload(Request $request)
    {
        ...
        $dataType = OGCRUD::model('DataType')->where('slug', '=', $slug)->firstOrFail();
        ...
        while (Storage::disk(config('ogcrud.storage.disk'))->exists($path.$filename.'.'.$file->getClientOriginalExtension())) {
        ...
        if (in_array($ext, ['jpeg', 'jpg', 'png', 'gif'])) {
            ...
            if (Storage::disk(config('ogcrud.storage.disk'))->put($fullPath, (string) $image, 'public')) {
        ...
        return OGCRUD::image($fullFilename);
    }
