...
trait OgCrudUser
{
    ...
    {
        return $this->belongsTo(OgCrud::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(OgCrud::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = OgCrud::model('Role')->where('name', '=', $name)->first();
