...
class OgCrudDummyServiceProvider extends ServiceProvider
{
    /**
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable = [
            ...
            'dummy_config' => [
                "{$publishablePath}/config/ogcrud_dummy.php" => config_path('ogcrud.php'),
            ],
            'dummy_migrations' => [
    ...
    public function registerConfigs()
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/../publishable/config/ogcrud_dummy.php',
            'ogcrud'
        );
    }
}
